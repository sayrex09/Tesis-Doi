...
def buscar_en_crossref(doi):
    ...
    try:
        ...
        fuentes = mensaje.get("container-title") or []
        return {
            ...
            "Revista/Conferencia": fuentes[0] if fuentes else "",
            "Volumen": mensaje.get("volume", ""),
            "Numero": mensaje.get("issue", ""),
            "Paginas": mensaje.get("page", "") or mensaje.get("article-number", ""),
            "URL": mensaje.get("URL", ""),
            "Editorial": mensaje.get("publisher", ""),
...
def buscar_datos_por_doi(doi):
    ...
    datos = {
        ...
        "Revista/Conferencia": datos_crossref.get("Revista/Conferencia", ""),
        "Volumen": datos_crossref.get("Volumen", ""),
        "Numero": datos_crossref.get("Numero", ""),
        "Paginas": datos_crossref.get("Paginas", ""),
        "URL": datos_crossref.get("URL", ""),
        "Editorial": datos_crossref.get("Editorial", ""),
